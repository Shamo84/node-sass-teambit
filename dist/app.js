...
$(document).ready(function () {
  ...
  $(document).on("click", function (event) {
    ...
    if ($(event.target).hasClass("fa-bars")) {
      ...
      $(event.target).parents("#navbar").children(".bars_dropdown").removeClass("hidden"); // click su X
...
__webpack_require__(/*! C:\Users\Ernesta\Documents\Boolean Careers\node-sass-teambit\src\app.js */"./src/app.js");
module.exports = __webpack_require__(/*! C:\Users\Ernesta\Documents\Boolean Careers\node-sass-teambit\src\app.scss */"./src/app.scss");
